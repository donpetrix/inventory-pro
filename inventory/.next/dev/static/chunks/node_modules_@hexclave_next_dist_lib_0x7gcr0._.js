...
"[project]/node_modules/@hexclave/next/dist/lib/auth.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let _hexclave_shared_dist_utils_strings = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/strings.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_errors = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/errors.js [app-client] (ecmascript)");
let _hexclave_shared = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/index.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_results = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/results.js [app-client] (ecmascript)");
let ___utils_url_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/utils/url.js [app-client] (ecmascript)");
let __cookie_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/cookie.js [app-client] (ecmascript)");
...
function getProviderOAuthErrorFromUrl(originalUrl) {
    ...
    switch(providerError){
        ...
        case "consent_required":
            return new _hexclave_shared.KnownErrors.OAuthProviderAccessDenied();
        default:
            return new _hexclave_shared.KnownErrors.OAuthProviderTemporarilyUnavailable();
    }
}
...
async function callOAuthCallback(iface, redirectUrl, options) {
    ...
    try {
        ...
        throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Error signing in during OAuth callback. Please try again.", {
            cause: e
        });
    }
}
...
exports.getNewOAuthProviderOrScopeUrl = getNewOAuthProviderOrScopeUrl;
}),
"[project]/node_modules/@hexclave/next/dist/lib/cookie.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
const require_rolldown_runtime = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/rolldown-runtime-D6vf50IK.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_errors = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/errors.js [app-client] (ecmascript)");
let _hexclave_sc_force_react_server = __turbopack_context__.r("[project]/node_modules/@hexclave/sc/dist/index.react-server.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_env = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/env.js [app-client] (ecmascript)");
let js_cookie = __turbopack_context__.r("[project]/node_modules/js-cookie/dist/js.cookie.js [app-client] (ecmascript)");
js_cookie = require_rolldown_runtime.__toESM(js_cookie);
...
function getAllCookiesClient() {
    ensureClient();
    js_cookie.default.set("hexclave-is-https", "true", {
        secure: true,
        expires: new Date(Date.now() + 1e3 * 60 * 60 * 24 * 365)
    });
...
exports.createCookieHelperSync = createCookieHelperSync;
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/api-keys/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let _hexclave_shared_dist_utils_objects = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/objects.js [app-client] (ecmascript)");
...
//#endregion
exports.apiKeyCreationOptionsToCrud = apiKeyCreationOptionsToCrud;
exports.apiKeyUpdateOptionsToCrud = apiKeyUpdateOptionsToCrud;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/admin-app-impl.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
let _hexclave_shared_dist_utils_objects = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/objects.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_results = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/results.js [app-client] (ecmascript)");
let __common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/common.js [app-client] (ecmascript)");
let _hexclave_shared_dist_helpers_production_mode = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/helpers/production-mode.js [app-client] (ecmascript)");
let ______common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/common.js [app-client] (ecmascript)");
let ______internal_api_keys_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/internal-api-keys/index.js [app-client] (ecmascript)");
let ______permissions_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/permissions/index.js [app-client] (ecmascript)");
let ______projects_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/projects/index.js [app-client] (ecmascript)");
let ______workflows_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/workflows.js [app-client] (ecmascript)");
let __server_app_impl_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/server-app-impl.js [app-client] (ecmascript)");
...
var _HexclaveAdminAppImplIncomplete = class extends __server_app_impl_js._HexclaveServerAppImplIncomplete {
    constructor(options, extraOptions){
            ...
            interface: extraOptions?.interface ?? (()=>{
                ...
                return new _hexclave_shared.HexclaveAdminInterface({
                    ...
                    ...resolvedOptions.projectOwnerSession ? {
                        ...
                        superSecretAdminKey: resolvedOptions.superSecretAdminKey ?? (0, __common_js.getDefaultSuperSecretAdminKey)()
                    }
                });
            })()
        });
        this._adminProjectCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.getProject();
        });
        this._planUsageCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.getPlanUsage();
        });
        this._internalApiKeysCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listInternalApiKeys();
        });
        this._adminEmailThemeCache = (0, __common_js.createCache)(async ([id])=>{
            return await this._interface.getEmailTheme(id);
        });
        this._adminEmailThemesCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listEmailThemes();
        });
        this._adminEmailTemplatesCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listInternalEmailTemplates();
        });
        this._adminEmailDraftsCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listInternalEmailDrafts();
        });
        this._adminWorkflowsCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listWorkflows();
        });
        this._adminTeamPermissionDefinitionsCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listTeamPermissionDefinitions();
        });
        this._adminProjectPermissionDefinitionsCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.listProjectPermissionDefinitions();
        });
        this._svixTokenCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.getSvixToken();
        });
        this._metricsCache = (0, __common_js.createCache)(async ([includeAnonymous, filtersKey])=>{
        ...
        this._userActivityCache = (0, __common_js.createCache)(async ([userId])=>{
            return await this._interface.getUserActivity(userId);
        });
        this._metricsUserCountsCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.getMetricsUserCounts();
        });
        this._emailPreviewCache = (0, __common_js.createCache)(async ([themeId, themeTsxSource, templateId, templateTsxSource])=>{
        ...
        this._emailPreviewWithEditableMarkersCache = (0, __common_js.createCache)(async ([themeId, themeTsxSource, templateId, templateTsxSource, editableSource])=>{
            return await this._interface.renderEmailPreview({
                themeId,
                themeTsxSource,
                templateId,
        ...
        this._configOverridesCache = (0, __common_js.createCache)(async ()=>{
            return await this._interface.getConfig();
        });
        this._stripeAccountInfoCache = (0, __common_js.createCache)(async ()=>{
            try {
        ...
        this._transactionsCache = (0, __common_js.createCache)(async ([cursor, limit, type, customerType, customerId])=>{
        ...
        return {
            ...
            config: {
                ...
                oauthProviders: data.config.oauth_providers.map((p)=>p.type === "shared" ? {
                        ...
                        clientSecret: p.id === "apple" ? p.client_secret : p.client_secret ?? (0, _hexclave_shared_dist_utils_errors.throwErr)("Client secret is missing"),
            ...
            useConfig () {
                const config = (0, __common_js.useAsyncCache)(app._configOverridesCache, [], "project.useConfig()");
                return (0, react.useMemo)(()=>app._adminConfigFromCrud(config), [
                    config
                ]);
            },
    ...
    useProject() {
        ...
        return (0, react.useMemo)(()=>this._adminProjectFromCrud(crud, ()=>this._refreshProject()), [
            crud
        ]);
    }
    async getPlanUsage() {
        return this._planUsageFromCrud(_hexclave_shared_dist_utils_results.Result.orThrow(await this._planUsageCache.getOrWait([], "write-only")));
    }
    usePlanUsage() {
        const crud = (0, __common_js.useAsyncCache)(this._planUsageCache, [], "adminApp.usePlanUsage()");
        return (0, react.useMemo)(()=>this._planUsageFromCrud(crud), [
            crud
        ]);
    }
    ...
    async createInternalApiKey(options) {
        const crud = await this._interface.createInternalApiKey((0, ______internal_api_keys_index_js.internalApiKeyCreateOptionsToCrud)(options));
        await this._refreshInternalApiKeys();
        return this._createInternalApiKeyFirstViewFromCrud(crud);
    }
    useEmailThemes() {
        const crud = (0, __common_js.useAsyncCache)(this._adminEmailThemesCache, [], "adminApp.useEmailThemes()");
        return (0, react.useMemo)(()=>{
    ...
    useEmailTemplates() {
        const crud = (0, __common_js.useAsyncCache)(this._adminEmailTemplatesCache, [], "adminApp.useEmailTemplates()");
        return (0, react.useMemo)(()=>{
    ...
    useEmailDrafts() {
        const crud = (0, __common_js.useAsyncCache)(this._adminEmailDraftsCache, [], "adminApp.useEmailDrafts()");
        return (0, react.useMemo)(()=>{
    ...
    useWorkflows() {
        const crud = (0, __common_js.useAsyncCache)(this._adminWorkflowsCache, [], "adminApp.useWorkflows()");
        return (0, react.useMemo)(()=>crud.map(______workflows_js.adminWorkflowFromCrud), [
            crud
        ]);
    }
    ...
    async listWorkflows() {
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._adminWorkflowsCache.getOrWait([], "write-only")).map(______workflows_js.adminWorkflowFromCrud);
    }
    async createWorkflow(options) {
        ...
        return (0, ______workflows_js.adminWorkflowSyncResultFromCrud)(result);
    }
    ...
    async listWorkflowVersions(workflowId) {
        return (await this._interface.listWorkflowVersions(workflowId)).map(______workflows_js.adminWorkflowVersionFromCrud);
    }
    async listWorkflowRuns(workflowId, filter = {}) {
        if (filter.includeState === true) {
            ...
            return {
                runs: result.runs.map((run)=>(0, ______workflows_js.adminWorkflowRunDetailsFromCrud)((0, ______workflows_js.isWorkflowRunDetailsJson)(run) ? run : (0, _hexclave_shared_dist_utils_errors.throwErr)("Workflow runs response omitted state after include_state=true"))),
        ...
        return {
            runs: result.runs.map(______workflows_js.adminWorkflowRunFromCrud),
            nextCursor: result.next_cursor
        };
    }
    async getWorkflowRun(runId) {
        return (0, ______workflows_js.adminWorkflowRunDetailsFromCrud)(await this._interface.getWorkflowRun(runId));
    }
    ...
    async createTeamPermissionDefinition(data) {
        const crud = await this._interface.createTeamPermissionDefinition((0, ______permissions_index_js.adminTeamPermissionDefinitionCreateOptionsToCrud)(data));
        await this._adminTeamPermissionDefinitionsCache.refresh([]);
        return this._serverTeamPermissionDefinitionFromCrud(crud);
    }
    async updateTeamPermissionDefinition(permissionId, data) {
        await this._interface.updateTeamPermissionDefinition(permissionId, (0, ______permissions_index_js.adminTeamPermissionDefinitionUpdateOptionsToCrud)(data));
        await this._adminTeamPermissionDefinitionsCache.refresh([]);
    }
    ...
    useTeamPermissionDefinitions() {
        const crud = (0, __common_js.useAsyncCache)(this._adminTeamPermissionDefinitionsCache, [], "adminApp.useTeamPermissionDefinitions()");
        return (0, react.useMemo)(()=>{
    ...
    async createProjectPermissionDefinition(data) {
        const crud = await this._interface.createProjectPermissionDefinition((0, ______permissions_index_js.adminProjectPermissionDefinitionCreateOptionsToCrud)(data));
    ...
    async updateProjectPermissionDefinition(permissionId, data) {
        await this._interface.updateProjectPermissionDefinition(permissionId, (0, ______permissions_index_js.adminProjectPermissionDefinitionUpdateOptionsToCrud)(data));
        await this._adminProjectPermissionDefinitionsCache.refresh([]);
    }
    ...
    useSvixToken() {
        const crud = (0, __common_js.useAsyncCache)(this._svixTokenCache, [], "adminApp.useSvixToken()");
        return {
            token: crud.token,
            url: crud.url
        };
    ...
    get [______common_js.hexclaveAppInternalsSymbol]() {
        return {
            ...super[______common_js.hexclaveAppInternalsSymbol],
            useMetrics: (includeAnonymous = false, filters)=>{
                ...
                return (0, __common_js.useAsyncCache)(this._metricsCache, [
                    includeAnonymous,
                    filtersKey
                ], "adminApp.useMetrics()");
            },
            useUserActivity: (userId)=>{
                return (0, __common_js.useAsyncCache)(this._userActivityCache, [
                    userId
                ], "adminApp.useUserActivity()");
            },
            useMetricsUserCounts: ()=>{
                return (0, __common_js.useAsyncCache)(this._metricsUserCountsCache, [], "adminApp.useMetricsUserCounts()");
            }
        };
    }
    async sendTestEmail(options) {
        ...
        try {
            ...
            if (error instanceof _hexclave_shared.KnownErrors.ItemQuantityInsufficientAmount) return _hexclave_shared_dist_utils_results.Result.error({
        ...
        else return _hexclave_shared_dist_utils_results.Result.error({
            errorMessage: response.error_message ?? (0, _hexclave_shared_dist_utils_errors.throwErr)("Email test error not specified")
        });
    }
    async sendTestWebhook(options) {
        ...
        if (response.success) return _hexclave_shared_dist_utils_results.Result.ok(void 0);
            ...
            errorMessage: response.error_message ?? (0, _hexclave_shared_dist_utils_errors.throwErr)("Webhook test error not specified")
        });
    }
    ...
    async getEmailPreview(options) {
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._emailPreviewCache.getOrWait([
            options.themeId,
    ...
    useEmailPreview(options) {
        return (0, __common_js.useAsyncCache)(this._emailPreviewCache, [
            options.themeId,
            options.themeTsxSource,
            options.templateId,
            options.templateTsxSource
    ...
    useEmailPreviewWithEditableMarkers(options) {
        const crud = (0, __common_js.useAsyncCache)(this._emailPreviewWithEditableMarkersCache, [
            options.themeId,
            options.themeTsxSource,
            options.templateId,
            options.templateTsxSource,
    ...
    useEmailTheme(id) {
        const crud = (0, __common_js.useAsyncCache)(this._adminEmailThemeCache, [
            id
    ...
    async createItemQuantityChange(options) {
        ...
        try {
            ...
            (0, _hexclave_shared_dist_utils_errors.captureError)("create-item-quantity-change-cache-refresh", error);
        }
    }
    ...
    _emailOutboxCrudToAdmin(crud) {
        ...
        return (()=>{
            switch(crud.status){
                ...
                default:
                    throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError(`Unknown email outbox status: ${crud.status}`, {
                        status: crud.status
                    });
            }
        })();
    ...
    useTransactions(params) {
        return (0, __common_js.useAsyncCache)(this._transactionsCache, [
            params.cursor,
            params.limit,
            params.type,
            params.customerType,
    ...
    async getStripeAccountInfo() {
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._stripeAccountInfoCache.getOrWait([], "write-only"));
    }
    useStripeAccountInfo() {
        return (0, __common_js.useAsyncCache)(this._stripeAccountInfoCache, [], "adminApp.useStripeAccountInfo()");
    }
...
//#endregion
exports._HexclaveAdminAppImplIncomplete = _HexclaveAdminAppImplIncomplete;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/client-app-impl.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
const require_rolldown_runtime = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/rolldown-runtime-D6vf50IK.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_promises = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/promises.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_strings = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/strings.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_errors = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/errors.js [app-client] (ecmascript)");
let react = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
react = require_rolldown_runtime.__toESM(react);
let _hexclave_shared = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/index.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_react = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/react.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_objects = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/objects.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_urls = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/urls.js [app-client] (ecmascript)");
let next_navigation = __turbopack_context__.r("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
next_navigation = require_rolldown_runtime.__toESM(next_navigation);
let _hexclave_shared_dist_utils_results = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/results.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_env = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/env.js [app-client] (ecmascript)");
let __common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/common.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_redirect_urls = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/redirect-urls.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_bytes = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/bytes.js [app-client] (ecmascript)");
let ______common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/common.js [app-client] (ecmascript)");
let ______projects_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/projects/index.js [app-client] (ecmascript)");
let _hexclave_shared_dist_sessions = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/sessions.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_stores = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/stores.js [app-client] (ecmascript)");
let __redirect_page_urls_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-page-urls.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_browser_action_snippets = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/browser-action-snippets.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_compile_time = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/compile-time.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_json = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/json.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_maps = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/maps.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_turnstile_flow = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/turnstile-flow.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_uuids = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/uuids.js [app-client] (ecmascript)");
let _simplewebauthn_browser = __turbopack_context__.r("[project]/node_modules/@simplewebauthn/browser/script/index.js [app-client] (ecmascript)");
let cookie = __turbopack_context__.r("[project]/node_modules/cookie/dist/index.js [app-client] (ecmascript)");
cookie = require_rolldown_runtime.__toESM(cookie);
let ____________generated_env_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/generated/env.js [app-client] (ecmascript)");
let ____________utils_react_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/utils/react.js [app-client] (ecmascript)");
let ____________utils_url_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/utils/url.js [app-client] (ecmascript)");
let _________auth_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/auth.js [app-client] (ecmascript)");
let _________cookie_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/cookie.js [app-client] (ecmascript)");
let ______api_keys_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/api-keys/index.js [app-client] (ecmascript)");
let ______contact_channels_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/contact-channels/index.js [app-client] (ecmascript)");
let ______passkey_rp_id_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/passkey-rp-id.js [app-client] (ecmascript)");
let ______teams_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/teams/index.js [app-client] (ecmascript)");
let ______url_targets_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/url-targets.js [app-client] (ecmascript)");
let ______users_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/users/index.js [app-client] (ecmascript)");
let __event_tracker_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/event-tracker.js [app-client] (ecmascript)");
let __redirect_back_state_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-back-state.js [app-client] (ecmascript)");
let __redirect_loop_breaker_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-loop-breaker.js [app-client] (ecmascript)");
let __session_refresh_subscription_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/session-refresh-subscription.js [app-client] (ecmascript)");
let __session_replay_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/session-replay.js [app-client] (ecmascript)");
let ____________clickmap_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/clickmap/index.js [app-client] (ecmascript)");
let ____________dev_tool_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/dev-tool/index.js [app-client] (ecmascript)");
let ____________pushed_config_error_overlay_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/pushed-config-error-overlay/index.js [app-client] (ecmascript)");
let ____________setup_error_overlay_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/setup-error-overlay/index.js [app-client] (ecmascript)");
let _hexclave_sc = __turbopack_context__.r("[project]/node_modules/@hexclave/sc/dist/index.default.js [app-client] (ecmascript)");
_hexclave_sc = require_rolldown_runtime.__toESM(_hexclave_sc);
...
function stripBrowserActionQueryParam() {
    ...
    const stripActionId = ()=>{
        ...
        if (currentUrl.searchParams.has(_hexclave_shared_dist_utils_browser_action_snippets.BROWSER_ACTION_QUERY_PARAM)) {
            currentUrl.searchParams.delete(_hexclave_shared_dist_utils_browser_action_snippets.BROWSER_ACTION_QUERY_PARAM);
...
*/ function createUntrustedUrlError(options) {
    const origin = (0, _hexclave_shared_dist_utils_urls.createUrlIfValid)(options.url)?.origin ?? options.url;
    return new _hexclave_shared_dist_utils_errors.HexclaveSetupError({
...
*/ function throwSetupError(error) {
    (0, ____________setup_error_overlay_index_js.showSetupErrorOverlay)(error);
    throw error;
}
...
async function isServerRedirectTargetCrossOrigin(url) {
    if ((0, _hexclave_shared_dist_utils_urls.isRelative)(url)) return false;
    const host = await getServerRequestHost();
    if (host == null) return true;
    const protocol = await (0, _________cookie_js.isSecure)() ? "https:" : "http:";
...
var _HexclaveClientAppImplIncomplete = class _HexclaveClientAppImplIncomplete {
    ...
    constructor(options, extraOptions){
        ...
        this._currentUserOAuthConnectionCache = (0, __common_js.createCacheBySession)(async (session, [providerId, scope, redirect])=>{
            return await this._getUserOAuthConnectionCacheFn({
                getUser: async ()=>_hexclave_shared_dist_utils_results.Result.orThrow(await this._currentUserCache.getOrWait([
                        session
                    ], "write-only")),
        ...
        this._currentUserValidConnectedAccountForProviderCache = (0, __common_js.createCacheBySession)(async (session, [provider, scopeString])=>{
            const matchingAccounts = _hexclave_shared_dist_utils_results.Result.orThrow(await this._currentUserConnectedAccountsCache.getOrWait([
                session
        ...
        const resolvedOptions = (0, __common_js.resolveConstructorOptions)(options);
        if (!_HexclaveClientAppImplIncomplete.LazyStackAdminAppImpl.value) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Admin app implementation not initialized. Did you import the _HexclaveClientApp from hexclave-app/apps/implementations/index.ts? You can't import it directly from ./apps/implementations/client-app-impl.ts as that causes a circular dependency (see the comment at _LazyHexclaveAdminAppImpl for more details).");
    ...
    _initializeAutomaticSideEffects(resolvedOptions) {
        if ((0, _hexclave_shared_dist_utils_env.isBrowserLike)() && (resolvedOptions.tokenStore === "cookie" || resolvedOptions.tokenStore === "nextjs-cookie")) {
            (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(this._trustedParentDomainCache.getOrWait([
        ...
        const sessionReplayOptions = (0, __session_replay_js.getSessionReplayOptions)(this._analyticsOptions);
        if (analyticsEnabled && (0, _hexclave_shared_dist_utils_env.isBrowserLike)() && this._hasPersistentTokenStore() && sessionReplayOptions.enabled) {
        ...
        if ((0, _hexclave_shared_dist_utils_env.isBrowserLike)() && (this._isOAuthCallbackUrlHosted() || this._currentUrlLooksLikeNestedCrossDomainOAuthCallback()) && (this._currentUrlLooksLikeHexclaveOAuthCallback() || this._currentUrlLooksLikeOAuthCallbackError())) this._trackPendingAuthResolution(async ()=>{
            if ((0, _hexclave_shared_dist_utils_env.isBrowserLike)()) await this._handleHostedOAuthCallbackDuringStartup();
        });
        if ((0, _hexclave_shared_dist_utils_env.isBrowserLike)()) {
            const urlAtConstructionTime = new URL(window.location.href);
            const actionId = urlAtConstructionTime.searchParams.get(_hexclave_shared_dist_utils_browser_action_snippets.BROWSER_ACTION_QUERY_PARAM);
            if (actionId != null) {
                ...
                (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(async ()=>{
                    try {
                        ...
                        if (_hexclave_shared.KnownErrors.VerificationCodeAlreadyUsed.isInstance(error) || _hexclave_shared.KnownErrors.VerificationCodeExpired.isInstance(error)) return;
                        throw error;
                    }
                });
            }
    ...
    _currentUrlLooksLikeHexclaveOAuthCallback() {
        ...
        return (0, _________cookie_js.getCookieClient)(`stack-oauth-outer-${state}`) != null || currentUrl.searchParams.has(nestedCrossDomainAuthQueryParams.refreshTokenId);
    }
    ...
    async _redirectToOAuthCallbackError(error) {
        ...
        const callbackUrl = (0, __redirect_back_state_js.augmentUrlWithPersistedRedirectBackState)({
    ...
    async _handleHostedOAuthCallbackDuringStartup() {
        try {
            ...
            if (_hexclave_shared.KnownError.isKnownError(error)) {
    ...
    async _maybeHandleNestedCrossDomainAuth(urlAtConstructionTime) {
        ...
        if (redirectUri != null || state != null || codeChallenge != null) {
            ...
            const redirectUriUrl = (0, _hexclave_shared_dist_utils_urls.isRelative)(redirectUri) ? null : (0, _hexclave_shared_dist_utils_urls.createUrlIfValid)(redirectUri);
            ...
            const afterCallbackRedirectUrl = afterCallbackRedirectUrlString == null ? redirectUriUrl : (0, _hexclave_shared_dist_utils_urls.createUrlIfValid)(afterCallbackRedirectUrlString, redirectUriUrl);
        ...
        const callbackUrl = (0, _hexclave_shared_dist_utils_urls.isRelative)(callbackUrlString) ? null : (0, _hexclave_shared_dist_utils_urls.createUrlIfValid)(callbackUrlString);
        ...
        nestedHandoffSourceUrl.searchParams.delete(__redirect_page_urls_js.crossDomainAuthQueryParams.state);
        nestedHandoffSourceUrl.searchParams.delete(__redirect_page_urls_js.crossDomainAuthQueryParams.codeChallenge);
	...
	*/ _getUniqueIdentifier() {
    ...
    async _getTrustedRedirectConfig() {
        ...
        return {
            ...
            trustedDomains: [
                ...
                new URL((0, ______url_targets_js.getHostedHandlerUrl)({
                    projectId: this.projectId,
                    pagePath: ""
                })).origin
            ]
        ...
        if (this._storedBrowserCookieTokenStore === null) {
            ...
            this._storedBrowserCookieTokenStore.onChange((value)=>{
                try {
                    ...
                    (0, _________cookie_js.setOrDeleteCookieClient)(this._accessTokenCookieName, accessTokenPayload, {
                        maxAge: 3600 * 24
                    });
                    cookieNamesToDelete.forEach((name)=>{
                        const domain = this._getDomainFromCustomRefreshCookieName(name);
                        (0, _________cookie_js.deleteCookieClient)(name, domain ? {
                            domain
                        } : {});
                    });
    ...
    _getOrCreateTokenStore(cookieHelper, overrideTokenStoreInit) {
        ...
        switch(tokenStoreInit){
            ...
            case "nextjs-cookie":
                if ((0, _hexclave_shared_dist_utils_env.isBrowserLike)()) return this._getBrowserCookieTokenStore();
                else {
                    ...
                    store.onChange((value)=>{
                        (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(async ()=>{
                            ...
                            await Promise.all([
                                (0, _________cookie_js.setOrDeleteCookie)(defaultName, refreshCookieValue, {
                                    maxAge: 3600 * 24 * 365,
                                    noOpIfServerComponent: true
                                }),
    ...
    _useTokenStore(overrideTokenStoreInit) {
        (0, ____________utils_react_js.suspendIfSsr)();
	...
	*/ _getSessionFromTokenStore(tokenStore, overrideTokenObj) {
    ...
    _useSession(overrideTokenStoreInit) {
        ...
        const getSnapshot = (0, react.useCallback)(()=>this._getSessionFromTokenStore(tokenStore), [
            tokenStore
        ]);
        return react.default.useSyncExternalStore(subscribe, getSnapshot, getSnapshot);
    }
    async _signInToAccountWithTokens(tokens) {
        if (!("accessToken" in tokens) || !("refreshToken" in tokens)) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Invalid tokens object; can't sign in with this", {
            tokens
        });
        ...
        await _hexclave_shared_dist_utils_results.Result.fromPromise(this._currentUserCache.getOrWait([
            session
        ], "write-only"));
    ...
    _clientTeamFromCrud(crud, session) {
        ...
        return {
            ...
            async listUsers () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._teamMemberProfilesCache.getOrWait([
                    session,
                    crud.id
            ...
            useUsers () {
                return (0, __common_js.useAsyncCache)(app._teamMemberProfilesCache, [
                    session,
                    crud.id
                ], "team.useUsers()").map((crud)=>app._clientTeamUserFromCrud(crud));
            },
            async listInvitations () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._teamInvitationsCache.getOrWait([
                    session,
                    crud.id
                ], "write-only")).map((crud)=>app._clientSentTeamInvitationFromCrud(session, crud));
            },
            useInvitations () {
                return (0, __common_js.useAsyncCache)(app._teamInvitationsCache, [
                    session,
                    crud.id
            ...
            useApiKeys () {
                return (0, __common_js.useAsyncCache)(app._teamApiKeysCache, [
                    session,
                    crud.id
                ], "team.useApiKeys()").map((crud)=>app._clientApiKeyFromCrud(session, crud));
            },
            async listApiKeys () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._teamApiKeysCache.getOrWait([
                    session,
                    crud.id
    ...
    _createUserExtraFromCurrent(crud, session) {
        ...
        async function getConnectedAccount(idOrAccount, options) {
            ...
            if (typeof idOrAccount === "object" && "provider" in idOrAccount && "providerAccountId" in idOrAccount) {
                ...
                const found = _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserConnectedAccountsCache.getOrWait([
                    session
        ...
        function useConnectedAccount(idOrAccount, options) {
            ...
            if (typeof idOrAccount === "object" && "provider" in idOrAccount && "providerAccountId" in idOrAccount) {
                const { provider, providerAccountId } = idOrAccount;
                return (0, __common_js.useAsyncCache)(app._currentUserConnectedAccountsCache, [
                    session
        ...
        return {
            ...
            async listConnectedAccounts () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserConnectedAccountsCache.getOrWait([
                    session
                ], "write-only"));
            },
            ...
            async getOrLinkConnectedAccount (provider, options) {
                const matchingAccounts = _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserConnectedAccountsCache.getOrWait([
                    session
                ], "write-only")).filter((a)=>a.provider === provider);
                for (const account of matchingAccounts)if ((await account.getAccessToken({
            ...
            async listTeams () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserTeamsCache.getOrWait([
                    session
                ], "write-only")).map((crud)=>app._clientTeamFromCrud(crud, session));
            },
            useTeams () {
                const teams = (0, __common_js.useAsyncCache)(app._currentUserTeamsCache, [
                    session
                ], "user.useTeams()");
                return (0, react.useMemo)(()=>teams.map((crud)=>app._clientTeamFromCrud(crud, session)), [
                    teams
                ]);
            },
            ...
            async listTeamInvitations () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserTeamInvitationsCache.getOrWait([
                    session
                ], "write-only")).map((crud)=>app._clientReceivedTeamInvitationFromCrud(session, crud));
            },
            useTeamInvitations () {
                const invitations = (0, __common_js.useAsyncCache)(app._currentUserTeamInvitationsCache, [
                    session
                ], "user.useTeamInvitations()");
                return (0, react.useMemo)(()=>invitations.map((crud)=>app._clientReceivedTeamInvitationFromCrud(session, crud)), [
                    invitations
                ]);
            },
            async listPermissions (scopeOrOptions, options) {
                if (scopeOrOptions && "id" in scopeOrOptions) {
                    ...
                    return _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserProjectPermissionsCache.getOrWait([
                        session,
                        recursive
                    ], "write-only")).map((crud)=>app._clientPermissionFromCrud(crud));
                }
            ...
            usePermissions (scopeOrOptions, options) {
                if (scopeOrOptions && "id" in scopeOrOptions) {
                    ...
                    return (0, react.useMemo)(()=>permissions.map((crud)=>app._clientPermissionFromCrud(crud)), [
                        permissions
                    ]);
                } else {
                    const recursive = scopeOrOptions?.recursive ?? true;
                    const permissions = (0, __common_js.useAsyncCache)(app._currentUserProjectPermissionsCache, [
                        session,
                        recursive
                    ], "user.usePermissions()");
                    return (0, react.useMemo)(()=>permissions.map((crud)=>app._clientPermissionFromCrud(crud)), [
            ...
            usePermission (scopeOrPermissionId, permissionId) {
                if (scopeOrPermissionId && typeof scopeOrPermissionId !== "string") {
                    ...
                    return (0, react.useMemo)(()=>permissions.find((p)=>p.id === permissionId) ?? null, [
                        permissions,
                        permissionId
                    ]);
                } else {
                    ...
                    return (0, react.useMemo)(()=>permissions.find((p)=>p.id === pid) ?? null, [
                        permissions,
                        pid
                    ]);
                }
            ...
            async getTeamProfile (team) {
                const result = _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserTeamProfileCache.getOrWait([
                    session,
                    team.id
                ], "write-only"));
            ...
            useTeamProfile (team) {
                const result = (0, __common_js.useAsyncCache)(app._currentUserTeamProfileCache, [
                    session,
                    team.id
                ], "user.useTeamProfile()");
                return app._editableTeamProfileFromCrud(result, session);
            ...
            async listContactChannels () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._clientContactChannelsCache.getOrWait([
                    session
                ], "write-only")).map((crud)=>app._clientContactChannelFromCrud(crud, session));
            },
            useContactChannels () {
                return (0, __common_js.useAsyncCache)(app._clientContactChannelsCache, [
                    session
            ...
            useNotificationCategories () {
                return (0, __common_js.useAsyncCache)(app._notificationCategoriesCache, [
                    session
            ...
            async listNotificationCategories () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._notificationCategoriesCache.getOrWait([
                    session
                ], "write-only")).map((crud)=>app._clientNotificationCategoryFromCrud(crud, session));
            },
            useApiKeys () {
                return (0, __common_js.useAsyncCache)(app._userApiKeysCache, [
                    session
            ...
            useOAuthProviders () {
                return (0, __common_js.useAsyncCache)(app._currentUserOAuthProvidersCache, [
                    session
                ], "user.useOAuthProviders()").map((crud)=>app._clientOAuthProviderFromCrud(crud, session));
            },
            async listOAuthProviders () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._currentUserOAuthProvidersCache.getOrWait([
                    session
                ], "write-only")).map((crud)=>app._clientOAuthProviderFromCrud(crud, session));
            },
            useOAuthProvider (id) {
                const providers = this.useOAuthProviders();
                return (0, react.useMemo)(()=>providers.find((p)=>p.id === id) ?? null, [
                    providers,
                    id
                ]);
            },
            ...
            async registerPasskey (options) {
                ...
                (0, ______passkey_rp_id_js.scopePasskeyRegistrationToHostname)(options_json, hostname);
                let attResp;
                try {
                    attResp = await (0, _simplewebauthn_browser.startRegistration)({
    ...
    _getUrls() {
        return (0, __common_js.getUrls)(this._urlOptions, {
            projectId: this.projectId
        });
    }
    ...
    async _createCrossDomainAuthRedirectUrl(options) {
        ...
        try {
            ...
            if (_hexclave_shared.KnownErrors.RedirectUrlNotWhitelisted.isInstance(error)) {
                const untrustedUrl = error.constructorArgs[0] ?? options.redirectUri;
                const untrustedUrlObject = (0, _hexclave_shared_dist_utils_urls.createUrlIfValid)(untrustedUrl);
        ...
        if (!("redirect_url" in result) || typeof result.redirect_url !== "string") throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Cross-domain authorization endpoint returned an invalid payload", {
            result
        });
    ...
    async _redirectTo(options) {
        if (this._redirectMethod !== "none" && (0, _hexclave_shared_dist_utils_env.isBrowserLike)()) {
            const currentUrl = new URL(window.location.href);
    ...
    async _getRedirectToHandlerUrl(handlerName, options, internalOptions) {
        const rawUrls = (0, __common_js.getUrls)(this._urlOptions, {
            projectId: this.projectId
        });
        ...
        if (currentUrl == null && ((0, ______url_targets_js.isHostedHandlerUrlForProject)({
            url: rawHandlerUrl,
            projectId: this.projectId
        ...
        if (currentUrl != null && shouldRestorePersistedRedirectBackState) currentUrl = (0, __redirect_back_state_js.augmentUrlWithPersistedRedirectBackState)({
            currentUrl,
            projectId: this.projectId
        });
    ...
    _isHandlerRedirectBrowserOnly(handlerName) {
        const rawHandlerUrl = (0, __common_js.getUrls)(this._urlOptions, {
            projectId: this.projectId
        })[handlerName];
        return (0, ______url_targets_js.isHostedHandlerUrlForProject)({
            url: rawHandlerUrl,
            projectId: this.projectId
        }) || !(0, _hexclave_shared_dist_utils_urls.isRelative)(rawHandlerUrl);
    }
    ...
    async getTeamInvitationDetails(code) {
        ...
        if (result.status === "ok") return _hexclave_shared_dist_utils_results.Result.ok({
    ...
    async getUser(options) {
        ...
        let crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._currentUserCache.getOrWait([
            session
        ], "write-only"));
    ...
    useUser(options) {
        ...
        let crud = (0, __common_js.useAsyncCache)(this._currentUserCache, [
            session
        ], "clientApp.useUser()");
        const includeAnonymous = options?.or === "anonymous" || options?.or === "anonymous-if-exists[deprecated]";
        const includeRestricted = options?.includeRestricted === true || includeAnonymous;
        const pendingSignOut = this._pendingSignOut;
        if (pendingSignOut != null) (0, _hexclave_shared_dist_utils_react.use)(pendingSignOut);
        if (crud === null || crud.is_anonymous && !includeAnonymous || crud.is_restricted && !includeRestricted) switch(options?.or){
            case "redirect":
                {
                    const handlerName = !crud?.is_anonymous && crud?.is_restricted ? "onboarding" : "signIn";
                    if (!(0, _hexclave_shared_dist_utils_env.isBrowserLike)() && this._isHandlerRedirectBrowserOnly(handlerName)) (0, ____________utils_react_js.suspendIfSsr)("useUser({ or: \"redirect\" })");
                    if (!this._redirectToHandlerDuringRender(handlerName, {
                        replace: true
                    })) (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(this._redirectToHandler(handlerName, {
                        replace: true
                    }));
    ...
    usePartialUser(options) {
        switch(options.from){
            ...
            case "convex":
                return (0, __common_js.useAsyncCache)(this._convexPartialUserCache, [
                    options.ctx
	...
	*/ async _catchMfaRequiredError(callback) {
        try {
            ...
            if (_hexclave_shared.KnownErrors.MultiFactorAuthenticationRequired.isInstance(e)) return _hexclave_shared_dist_utils_results.Result.ok(await this._experimentalMfa(e, await this._getSession(void 0, {
                awaitPendingAuthResolutions: false
            })));
            throw e;
        }
        ...
        const executeSignUp = async (challenge)=>{
            ...
            if (result.status === "error" && result.error instanceof _hexclave_shared.KnownErrors.RedirectUrlNotWhitelisted && emailVerificationRedirectUrl !== void 0) {
                if (!options.verificationCallbackUrl) {
                    (0, _hexclave_shared_dist_utils_errors.captureError)("signup-verification-url-not-whitelisted", new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("The auto-constructed verification callback URL is not whitelisted; proceeding without email verification", {
	...
	*/ async promptCliLogin(options) {
    ...
    async signInWithPasskey() {
        ...
        try {
            result = await this._catchMfaRequiredError(async ()=>{
                ...
                const { options_json, code } = initiationResult.data;
                (0, ______passkey_rp_id_js.scopePasskeyAuthenticationToHostname)(options_json, window.location.hostname);
                const authentication_response = await (0, _simplewebauthn_browser.startAuthentication)({
                    optionsJSON: options_json
                });
    ...
    async callOAuthCallback(options) {
        ...
        const currentUrl = new URL(window.location.href);
        if (currentUrl.searchParams.get(__redirect_page_urls_js.crossDomainAuthQueryParams.marker) === "1" || currentUrl.searchParams.has(nestedCrossDomainAuthQueryParams.refreshTokenId)) {
    ...
    async _signOut(session, options) {
        ...
        const signOutBarrier = (async ()=>{
            await _hexclave_shared_dist_utils_results.Result.fromPromise(signOutOperation);
        })();
    ...
    useProject() {
        ...
        return (0, react.useMemo)(()=>this._clientProjectFromCrud(crud), [
            crud
        ]);
    }
    async _listOwnedProjects(session) {
        this._ensureInternalProject();
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._ownedProjectsCache.getOrWait([
            session
    ...
    _useOwnedProjects(session) {
        this._ensureInternalProject();
        const projects = (0, __common_js.useAsyncCache)(this._ownedProjectsCache, [
            session
        ], "clientApp.useOwnedProjects()");
        return (0, react.useMemo)(()=>projects.map((j)=>this._getOwnedAdminApp(j.id, session)._adminOwnedProjectFromCrud(j, ()=>this._refreshOwnedProjects(session))), [
            projects
        ]);
    }
    ...
    static get [______common_js.hexclaveAppInternalsSymbol]() {
        return {
            fromClientJson: (json)=>{
                ...
                const { analytics, ...restJson } = (0, _hexclave_shared_dist_utils_objects.omit)(json, [
                    "uniqueIdentifier"
                ]);
    ...
    get [______common_js.hexclaveAppInternalsSymbol]() {
        return {
            ...
            setCurrentUser: (userJsonPromise)=>{
                (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(async ()=>{
                    await this._currentUserCache.forceSetCachedValueAsync([
                        await this._getSession()
                    ], _hexclave_shared_dist_utils_results.Result.fromPromise(userJsonPromise));
                });
            },
            ...
            getRawAfterAuthReturnTo: ()=>{
                ...
                return (0, __redirect_back_state_js.getRawAfterAuthReturnTo)({
                    currentUrl: new URL(window.location.href),
                    projectId: this.projectId
                });
            },
...
//#endregion
exports._HexclaveClientAppImplIncomplete = _HexclaveClientAppImplIncomplete;
exports.stripBrowserActionQueryParam = stripBrowserActionQueryParam;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/common.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
let _hexclave_shared_dist_utils_objects = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/objects.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_urls = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/urls.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_caches = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/caches.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_results = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/results.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_env = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/env.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_globals = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/globals.js [app-client] (ecmascript)");
let ______common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/common.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_stores = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/stores.js [app-client] (ecmascript)");
let ____________generated_env_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/generated/env.js [app-client] (ecmascript)");
let ____________utils_react_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/utils/react.js [app-client] (ecmascript)");
...
const createCacheBySession = (fetcher)=>{
    return new _hexclave_shared_dist_utils_caches.AsyncCache(async ([session, ...extraDependencies])=>await _hexclave_shared_dist_utils_results.Result.fromThrowingAsync(async ()=>await fetcher(session, extraDependencies)), {
...
function resolveConstructorOptions(options) {
    return {
        ...options.inheritsFrom?.[______common_js.hexclaveAppInternalsSymbol].getConstructorOptions() ?? {},
        ...(0, _hexclave_shared_dist_utils_objects.filterUndefined)((0, _hexclave_shared_dist_utils_objects.omit)(options, [
            "inheritsFrom"
        ]))
    };
}
...
*/ function getBaseUrl(userSpecifiedBaseUrl) {
    ...
    if (userSpecifiedBaseUrl) if (typeof userSpecifiedBaseUrl === "string") url = userSpecifiedBaseUrl;
        ...
        url = url || ____________generated_env_js.envVars.HEXCLAVE_API_URL || "https://api.hexclave.com";
    }
...
function fetchBackendUrlsInBackground(primaryBaseUrl) {
    (0, _hexclave_shared_dist_utils_globals.createGlobal)("__stack-fetch-backend-urls-started", ()=>{
        (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(async ()=>{
            try {
                ...
                (0, _hexclave_shared_dist_utils_globals.createGlobal)("__stack-fetched-backend-urls", ()=>data.urls);
            } catch (e) {
                (0, _hexclave_shared_dist_utils_errors.captureError)("fetch-backend-urls-in-background", e);
            }
        });
        return true;
    });
...
function resolveApiUrls(userExplicitBaseUrl) {
    return ()=>{
        ...
        return (0, _hexclave_shared_dist_utils_globals.getGlobal)("__stack-fetched-backend-urls") ?? (0, _hexclave_shared_dist_utils_urls.getDefaultApiUrls)(primary);
    };
}
function createEmptyTokenStore() {
    return new _hexclave_shared_dist_utils_stores.Store({
        refreshToken: null,
        accessToken: null
    });
}
...
function useAsyncCache(cache, dependencies, caller) {
    (0, ____________utils_react_js.suspendIfSsr)(caller);
    const asyncCacheHooks = (0, _hexclave_shared_dist_utils_globals.getGlobal)("use-async-cache-execution-hooks") ?? [];
    ...
    const result = (0, _hexclave_shared_dist_utils_react.use)(react.default.useSyncExternalStore(subscribe, getSnapshot, getSnapshot));
    if (result.status === "error") {
        const error = result.error;
        if (error instanceof Error && !error.__stackHasConcatenatedStacktraces) {
            (0, _hexclave_shared_dist_utils_errors.concatStacktraces)(error, /* @__PURE__ */ new Error());
...
exports.resolveApiUrls = resolveApiUrls;
exports.resolveConstructorOptions = resolveConstructorOptions;
exports.useAsyncCache = useAsyncCache;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/event-tracker.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let _hexclave_shared_dist_utils_dev_tool = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/dev-tool.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_dom = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/dom.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_elements_chain = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/elements-chain.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_promises = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/promises.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_env = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/env.js [app-client] (ecmascript)");
let __session_replay_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/session-replay.js [app-client] (ecmascript)");
...
var EventTracker = class {
    constructor(deps){
        ...
        this._onPageHide = ()=>{
            (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(()=>this._flush({
                    keepalive: true
                }));
        };
        this._deps = deps;
    ...
    _pushEvent(event) {
        ...
        if (this._events.length >= MAX_EVENTS_PER_BATCH || this._approxBytes >= MAX_APPROX_BYTES_PER_BATCH) (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(()=>this._flush({
                keepalive: false
            }));
    }
    ...
    async _flush(options) {
        ...
        if (res.status === "error") {
            ...
            if ((0, __session_replay_js.isAdBlockerNetworkError)(res.error)) return;
    ...
    _tick() {
        ...
        if (this._events.length > 0) (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(()=>this._flush({
                keepalive: false
            }));
    }
};
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let __server_app_impl_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/server-app-impl.js [app-client] (ecmascript)");
let __client_app_impl_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/client-app-impl.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_compile_time = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/compile-time.js [app-client] (ecmascript)");
let __admin_app_impl_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/admin-app-impl.js [app-client] (ecmascript)");
...
*/ function complete() {
    __client_app_impl_js._HexclaveClientAppImplIncomplete.LazyStackAdminAppImpl.value = __admin_app_impl_js._HexclaveAdminAppImplIncomplete;
    return {
        _HexclaveAdminAppImpl: (0, _hexclave_shared_dist_utils_compile_time.scrambleDuringCompileTime)(__admin_app_impl_js._HexclaveAdminAppImplIncomplete),
        _HexclaveClientAppImpl: (0, _hexclave_shared_dist_utils_compile_time.scrambleDuringCompileTime)(__client_app_impl_js._HexclaveClientAppImplIncomplete),
        _HexclaveServerAppImpl: (0, _hexclave_shared_dist_utils_compile_time.scrambleDuringCompileTime)(__server_app_impl_js._HexclaveServerAppImplIncomplete)
    };
}
const { _HexclaveAdminAppImpl, _HexclaveClientAppImpl, _HexclaveServerAppImpl } = complete();
//#endregion
exports._HexclaveAdminAppImpl = _HexclaveAdminAppImpl;
exports._HexclaveClientAppImpl = _HexclaveClientAppImpl;
exports._HexclaveServerAppImpl = _HexclaveServerAppImpl;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-back-state.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let __redirect_page_urls_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-page-urls.js [app-client] (ecmascript)");
let ____________utils_session_storage_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/utils/session-storage.js [app-client] (ecmascript)");
...
exports.getRawAfterAuthReturnTo = getRawAfterAuthReturnTo;
exports.readRedirectBackState = readRedirectBackState;
exports.saveRedirectBackStateFromUrl = saveRedirectBackStateFromUrl;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-loop-breaker.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/redirect-page-urls.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function buildCrossDomainAuthCallbackUrl(options) {
    ...
    if (localOAuthCallbackUrl.origin !== options.currentUrl.origin) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Cross-domain auth callback URL must stay on the current origin", {
...
function buildRedirectBackAwareHandlerUrl(options) {
    ...
    if (options.handlerName === "signOut") {
        if (!nextUrl.searchParams.has("after_auth_return_to")) if (options.currentUrl.protocol === nextUrl.protocol && options.currentUrl.host === nextUrl.host) nextUrl.searchParams.set("after_auth_return_to", (0, _hexclave_shared_dist_utils_urls.getRelativePart)(options.currentUrl));
        else nextUrl.searchParams.set("after_auth_return_to", options.currentUrl.toString());
        return nextUrl.origin === options.currentUrl.origin ? (0, _hexclave_shared_dist_utils_urls.getRelativePart)(nextUrl) : nextUrl.toString();
    }
    ...
    } else if (!options.noRedirectBack && options.currentUrl.protocol === nextUrl.protocol && options.currentUrl.host === nextUrl.host && !nextUrl.searchParams.has("after_auth_return_to")) nextUrl.searchParams.set("after_auth_return_to", (0, _hexclave_shared_dist_utils_urls.getRelativePart)(options.currentUrl));
    return nextUrl.origin === options.currentUrl.origin ? (0, _hexclave_shared_dist_utils_urls.getRelativePart)(nextUrl) : nextUrl.toString();
}
/**
...
async function planRedirectToHandler(options) {
    ...
    if (options.handlerName !== "signIn" && options.handlerName !== "signUp" && options.handlerName !== "onboarding" && options.handlerName !== "signOut") throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("Unexpected redirect-back-aware handler policy mismatch", {
        handlerName: options.handlerName,
        policy
    });
...
//#endregion
exports.crossDomainAuthQueryParams = crossDomainAuthQueryParams;
exports.getCrossDomainHandoffParamsFromCurrentUrl = getCrossDomainHandoffParamsFromCurrentUrl;
exports.planRedirectToHandler = planRedirectToHandler;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/server-app-impl.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var _HexclaveServerAppImplIncomplete = class extends __client_app_impl_js._HexclaveClientAppImplIncomplete {
    ...
    constructor(options, extraOptions){
        ...
        super(resolvedOptions, {
            ...
            interface: extraOptions?.interface ?? (()=>{
                const apiUrls = (0, __common_js.resolveApiUrls)(resolvedOptions.baseUrl);
                return new _hexclave_shared.HexclaveServerInterface({
                    getBaseUrl: ()=>apiUrls()[0],
                    getApiUrls: apiUrls,
                    projectId: resolvedOptions.projectId ?? (0, __common_js.getDefaultProjectId)(),
                    extraRequestHeaders: resolvedOptions.extraRequestHeaders ?? (0, __common_js.getDefaultExtraRequestHeaders)(),
        ...
        this._serverUsersCache = (0, __common_js.createCache)(async ([cursor, limit, orderBy, desc, query, includeRestricted, includeAnonymous, onlyAnonymous, teamId, excludedEmailDomains])=>{
            if (onlyAnonymous && !includeAnonymous) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("onlyAnonymous=true requires includeAnonymous=true");
        ...
        this._serverUserCache = (0, __common_js.createCache)(async ([userId])=>{
            ...
            return _hexclave_shared_dist_utils_results.Result.or(user, null);
        });
        ...
        this._serverUserOAuthConnectionCache = (0, __common_js.createCache)(async ([userId, providerId, scope, redirect])=>{
            return await this._getUserOAuthConnectionCacheFn({
                getUser: async ()=>_hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUserCache.getOrWait([
                        userId
                    ], "write-only")),
                getOrWaitOAuthToken: async ()=>_hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUserOAuthConnectionAccessTokensCache.getOrWait([
                        userId,
                        providerId,
                        scope || ""
                    ], "write-only")),
        ...
        return {
            ...
            update: async (options)=>{
                await this._interface.updateProjectApiKey(crud.type === "team" ? {
                    ...
                    user_id: crud.user_id
                }, crud.id, await (0, ______api_keys_index_js.apiKeyUpdateOptionsToCrud)(crud.type, options), null, "server");
    ...
    _createServerOAuthConnectionFromCrudItem(userId, item) {
        ...
        return {
            ...
            async getAccessToken (options) {
                const scopeString = options?.scopes?.join(" ") ?? "";
                const result = _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserOAuthConnectionAccessTokensByAccountCache.getOrWait([
                    userId,
                    providerId,
                    providerAccountId,
                    scopeString
    ...
    _serverUserFromCrud(crud) {
        ...
        async function getConnectedAccount(idOrAccount, options) {
            ...
            if (typeof idOrAccount === "object" && "provider" in idOrAccount && "providerAccountId" in idOrAccount) {
                const { provider, providerAccountId } = idOrAccount;
                const found = _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserConnectedAccountsCache.getOrWait([
                    crud.id
                ], "write-only")).find((a)=>a.provider === provider && a.providerAccountId === providerAccountId);
                if (!found) return null;
                return found;
            }
            return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserOAuthConnectionCache.getOrWait([
                crud.id,
                idOrAccount,
                scopeString,
                options?.or === "redirect"
        ...
        function useConnectedAccount(idOrAccount, options) {
            ...
            if (typeof idOrAccount === "object" && "provider" in idOrAccount && "providerAccountId" in idOrAccount) {
                const { provider, providerAccountId } = idOrAccount;
                return (0, __common_js.useAsyncCache)(app._serverUserConnectedAccountsCache, [
                    crud.id
                ], "user.useConnectedAccount()").find((a)=>a.provider === provider && a.providerAccountId === providerAccountId) ?? null;
            }
        ...
        return (0, ______users_index_js.withUserDestructureGuard)({
            ...
            useConnectedAccount,
            async listConnectedAccounts () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserConnectedAccountsCache.getOrWait([
                    crud.id
                ], "write-only"));
            },
            useConnectedAccounts () {
            ...
            async linkConnectedAccount () {
                throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("linkConnectedAccount is not available for server users. OAuth flows must be initiated on the client side.");
            },
            async getOrLinkConnectedAccount () {
                throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("getOrLinkConnectedAccount is not available for server users. OAuth flows must be initiated on the client side.");
            },
            useOrLinkConnectedAccount () {
                throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("useOrLinkConnectedAccount is not available for server users. OAuth flows must be initiated on the client side.");
            },
            ...
            async listTeams (options) {
                const result = _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverTeamsCache.getOrWait([
                    crud.id,
                    options?.orderBy,
                    options?.desc,
                    options?.cursor,
            ...
            async listTeamInvitations () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserTeamInvitationsCache.getOrWait([
                    crud.id
                ], "write-only")).map((inv)=>app._serverReceivedTeamInvitationFromCrud(crud.id, inv));
            },
            useTeamInvitations () {
                const invitations = (0, __common_js.useAsyncCache)(app._serverUserTeamInvitationsCache, [
                    crud.id
                ], "user.useTeamInvitations()");
                return (0, react.useMemo)(()=>invitations.map((inv)=>app._serverReceivedTeamInvitationFromCrud(crud.id, inv)), [
                    invitations
                ]);
            },
            async listPermissions (scopeOrOptions, options) {
                if (scopeOrOptions && "id" in scopeOrOptions) {
                    const scope = scopeOrOptions;
                    const recursive = options?.recursive ?? true;
                    return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverTeamUserPermissionsCache.getOrWait([
                        scope.id,
                        crud.id,
                        recursive
                    ...
                    const recursive = scopeOrOptions?.recursive ?? true;
                    return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserProjectPermissionsCache.getOrWait([
                        crud.id,
                        recursive
                    ], "write-only")).map((crud)=>app._serverPermissionFromCrud(crud));
                }
            ...
            usePermissions (scopeOrOptions, options) {
                if (scopeOrOptions && "id" in scopeOrOptions) {
                    ...
                    return (0, react.useMemo)(()=>permissions.map((crud)=>app._serverPermissionFromCrud(crud)), [
                        permissions
                    ]);
                } else {
                    const recursive = scopeOrOptions?.recursive ?? true;
                    const permissions = (0, __common_js.useAsyncCache)(app._serverUserProjectPermissionsCache, [
                        crud.id,
                        recursive
                    ], "user.usePermissions()");
                    return (0, react.useMemo)(()=>permissions.map((crud)=>app._serverPermissionFromCrud(crud)), [
            ...
            async getTeamProfile (team) {
                const result = _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserTeamProfileCache.getOrWait([
                    team.id,
                    crud.id
                ], "write-only"));
            ...
            useTeamProfile (team) {
                const result = (0, __common_js.useAsyncCache)(app._serverUserTeamProfileCache, [
                    team.id,
                    crud.id
                ], "user.useTeamProfile()");
                return (0, react.useMemo)(()=>app._serverEditableTeamProfileFromCrud(result), [
                    result
                ]);
            },
            async listContactChannels () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverContactChannelsCache.getOrWait([
                    crud.id
                ], "write-only")).map((data)=>app._serverContactChannelFromCrud(crud.id, data));
            },
            useContactChannels () {
                const result = (0, __common_js.useAsyncCache)(app._serverContactChannelsCache, [
                    crud.id
                ], "user.useContactChannels()");
                return (0, react.useMemo)(()=>result.map((data)=>app._serverContactChannelFromCrud(crud.id, data)), [
                    result
                ]);
            },
            ...
            useNotificationCategories () {
                return (0, __common_js.useAsyncCache)(app._serverNotificationCategoriesCache, [
                    crud.id
                ], "user.useNotificationCategories()").map((category)=>app._serverNotificationCategoryFromCrud(crud.id, category));
            },
            async listNotificationCategories () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverNotificationCategoriesCache.getOrWait([
                    crud.id
                ], "write-only")).map((category)=>app._serverNotificationCategoryFromCrud(crud.id, category));
            },
            useApiKeys () {
                return (0, __common_js.useAsyncCache)(app._serverUserApiKeysCache, [
                    crud.id
                ], "user.useApiKeys()").map((apiKey)=>app._serverApiKeyFromCrud(apiKey));
            },
            async listApiKeys () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverUserApiKeysCache.getOrWait([
                    crud.id
            ...
            useOAuthProviders () {
                const results = (0, __common_js.useAsyncCache)(app._serverOAuthProvidersCache, [
                    crud.id
                ], "user.useOAuthProviders()");
                return (0, react.useMemo)(()=>results.map((oauthCrud)=>app._serverOAuthProviderFromCrud(oauthCrud)), [
                    results
                ]);
            },
            async listOAuthProviders () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverOAuthProvidersCache.getOrWait([
                    crud.id
            ...
            async registerPasskey (options) {
                ...
                const tempSession = new _hexclave_shared_dist_sessions.InternalSession({
                    accessToken,
                    refreshToken,
    ...
    _serverTeamFromCrud(crud) {
        ...
        return {
            ...
            async listUsers () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverTeamMemberProfilesCache.getOrWait([
                    crud.id
                ], "write-only")).map((u)=>app._serverTeamUserFromCrud(u));
            },
            useUsers () {
                const result = (0, __common_js.useAsyncCache)(app._serverTeamMemberProfilesCache, [
                    crud.id
                ], "team.useUsers()");
                return (0, react.useMemo)(()=>result.map((u)=>app._serverTeamUserFromCrud(u)), [
                    result
                ]);
            },
            ...
            async listInvitations () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverTeamInvitationsCache.getOrWait([
                    crud.id
                ], "write-only")).map((crud)=>app._serverSentTeamInvitationFromCrud(crud));
            },
            useInvitations () {
                const result = (0, __common_js.useAsyncCache)(app._serverTeamInvitationsCache, [
                    crud.id
                ], "team.useInvitations()");
                return (0, react.useMemo)(()=>result.map((crud)=>app._serverSentTeamInvitationFromCrud(crud)), [
                    result
                ]);
            },
            useApiKeys () {
                return (0, __common_js.useAsyncCache)(app._serverTeamApiKeysCache, [
                    crud.id
                ], "team.useApiKeys()").map((apiKey)=>app._serverApiKeyFromCrud(apiKey));
            },
            async listApiKeys () {
                return _hexclave_shared_dist_utils_results.Result.orThrow(await app._serverTeamApiKeysCache.getOrWait([
                    crud.id
                ], "write-only")).map((apiKey)=>app._serverApiKeyFromCrud(apiKey));
            },
            async createApiKey (options) {
        ...
        return {
            ...
            tryDecreaseQuantity: async (delta)=>{
                try {
                    ...
                    if (error instanceof _hexclave_shared.KnownErrors.ItemQuantityInsufficientAmount) return false;
                    throw error;
                }
            }
        };
    ...
    async _getUserApiKey(options) {
        const crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverCheckApiKeyCache.getOrWait([
            "user",
            options.apiKey
        ], "write-only"));
    ...
    _useUserApiKey(options) {
        const crud = (0, __common_js.useAsyncCache)(this._serverCheckApiKeyCache, [
            "user",
            options.apiKey
        ], "serverApp.useUserApiKey()");
        return (0, react.useMemo)(()=>crud ? this._serverApiKeyFromCrud(crud) : null, [
            crud
        ]);
    }
    ...
    _useUserByConvex(ctx, includeAnonymous) {
        const subject = (0, __common_js.useAsyncCache)(this._convexIdentitySubjectCache, [
            ctx
    ...
    async getUser(options) {
        if (typeof options === "string") return await this.getServerUserById(options);
            ...
            this._ensurePersistentTokenStore(options?.tokenStore);
            const session = await this._getSession(options?.tokenStore);
            let crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._currentServerUserCache.getOrWait([
                session
            ], "write-only"));
            const includeAnonymous = options?.or === "anonymous" || options?.or === "anonymous-if-exists[deprecated]";
            const includeRestricted = options?.includeRestricted === true || includeAnonymous;
    ...
    async getServerUserById(userId) {
        const crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUserCache.getOrWait([
            userId
        ], "write-only"));
    ...
    useUser(options) {
        if (typeof options === "string") return this.useUserById(options);
            ...
            this._ensurePersistentTokenStore(options?.tokenStore);
            const session = this._useSession(options?.tokenStore);
            let crud = (0, __common_js.useAsyncCache)(this._currentServerUserCache, [
                session
            ], "serverApp.useUser()");
            ...
            if (crud === null) switch(options?.or){
                case "redirect":
                    (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(this.redirectToSignIn({
                        replace: true
                    }));
                    (0, _hexclave_shared_dist_utils_react.suspend)();
                    throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("suspend should never return");
    ...
    useUserById(userId) {
        const crud = (0, __common_js.useAsyncCache)(this._serverUserCache, [
            userId
    ...
    async listUsers(options) {
        ...
        const crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUsersCache.getOrWait([
            options?.cursor,
            options?.limit,
            options?.orderBy,
            options?.desc,
    ...
    async getItem(options) {
        if ("userId" in options) {
            const result = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUserItemsCache.getOrWait([
                options.userId,
                options.itemId
            ], "write-only"));
            ...
            const result = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverTeamItemsCache.getOrWait([
                options.teamId,
                options.itemId
            ], "write-only"));
            return this._serverItemFromCrud({
            ...
            const result = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverCustomItemsCache.getOrWait([
                options.customCustomerId,
                options.itemId
            ], "write-only"));
            return this._serverItemFromCrud({
    ...
    async listProducts(options) {
        if ("userId" in options) {
            const response = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverUserProductsCache.getOrWait([
                options.userId,
                options.cursor ?? null,
                options.limit ?? null
            ], "write-only"));
            ...
            const response = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverTeamProductsCache.getOrWait([
                options.teamId,
                options.cursor ?? null,
                options.limit ?? null
            ], "write-only"));
        ...
        const response = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverCustomProductsCache.getOrWait([
            options.customCustomerId,
            options.cursor ?? null,
            options.limit ?? null
        ], "write-only"));
    ...
    async listTeams(options) {
        const crud = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverTeamsCache.getOrWait([
            void 0,
            options?.orderBy,
            options?.desc,
            options?.cursor,
    ...
    async listTeamMemberPermissions(teamId, options) {
        ...
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverAllTeamMemberPermissionsCache.getOrWait([
            teamId,
            recursive
        ], "write-only")).map((r)=>({
                userId: r.user_id,
    ...
    useTeamMemberPermissions(teamId, options) {
        const recursive = options?.recursive ?? false;
        const rows = (0, __common_js.useAsyncCache)(this._serverAllTeamMemberPermissionsCache, [
            teamId,
            recursive
    ...
    async getTeam(options) {
        if (typeof options === "object" && "apiKey" in options) return await this._getTeamByApiKey(options.apiKey);
            ...
            const team = _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverTeamCache.getOrWait([
                teamId
            ], "write-only"));
    ...
    useTeam(options) {
        if (typeof options === "object" && "apiKey" in options) return this._useTeamByApiKey(options.apiKey);
            ...
            const teamId = options;
            const team = (0, __common_js.useAsyncCache)(this._serverTeamCache, [
                teamId ?? ""
            ], "serverApp.useTeam()");
            return (0, react.useMemo)(()=>{
                return team == null ? null : this._serverTeamFromCrud(team);
    ...
    _createServerDataVaultStore(id) {
        ...
        return {
            ...
            getValue: async (key, options)=>{
                validateOptions(options);
                return _hexclave_shared_dist_utils_results.Result.orThrow(await this._serverDataVaultStoreValueCache.getOrWait([
                    id,
                    key,
                    options.secret
                ], "write-only"));
    ...
    useDataVaultStore(id) {
        return (0, react.useMemo)(()=>this._createServerDataVaultStore(id), [
            id
        ]);
    }
    ...
    async getEmailDeliveryStats() {
        return _hexclave_shared_dist_utils_results.Result.orThrow(await this._emailDeliveryInfoCache.getOrWait([], "write-only"));
    }
    useEmailDeliveryStats() {
        return (0, __common_js.useAsyncCache)(this._emailDeliveryInfoCache, [], "hexclaveServerApp.useEmailDeliveryStats()");
    }
    ...
    async createOAuthProvider(options) {
        try {
            ...
            return _hexclave_shared_dist_utils_results.Result.ok(this._serverOAuthProviderFromCrud(crud));
        } catch (error) {
            if (_hexclave_shared.KnownErrors.OAuthProviderAccountIdAlreadyUsedForSignIn.isInstance(error)) return _hexclave_shared_dist_utils_results.Result.error(error);
            throw error;
        }
...
//#endregion
exports._HexclaveServerAppImplIncomplete = _HexclaveServerAppImplIncomplete;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/session-refresh-subscription.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//#endregion
exports.subscribeSessionRefresh = subscribeSessionRefresh;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/session-replay.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
let _hexclave_shared_dist_utils_results = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/results.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_env = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/env.js [app-client] (ecmascript)");
let _hexclave_shared_dist_known_errors = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/known-errors.js [app-client] (ecmascript)");
...
var SessionRecorder = class {
	...
	*/ start() {
        ...
        if (!(0, _hexclave_shared_dist_utils_env.isBrowserLike)()) return;
        this._started = true;
        (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(()=>this._startRecording(), {
            noErrorLogging: true
        });
        this._flushTimer = setInterval(()=>this._tick(), FLUSH_INTERVAL_MS);
    }
        ...
        try {
            ...
            while(offset < allEvents.length){
                ...
                if (firstSize > maxSingleEventBytes) {
                    (0, _hexclave_shared_dist_utils_errors.captureWarning)("SessionRecorder.flush", /* @__PURE__ */ new Error(`Dropping oversized session replay event (${firstSize} bytes > ${maxSingleEventBytes} byte limit); it cannot be sent without exceeding the server's body limit.`));
                    offset += 1;
                    continue;
                }
                let batchBytes = 0;
                ...
                if (!res.data.ok) {
                    ...
                    if (res.data.status === 413) {
                        (0, _hexclave_shared_dist_utils_errors.captureWarning)("SessionRecorder.flush", /* @__PURE__ */ new Error(`Session replay batch rejected with 413 (payload too large) despite client-side size caps; dropping ${droppedCount} buffered event(s). A poorly-compressible event likely exceeded the server's body limit after gzip.`));
                        return;
                    }
                    (0, _hexclave_shared_dist_utils_errors.captureWarning)("SessionRecorder.flush", /* @__PURE__ */ new Error(`SessionRecorder flush failed (dropping ${droppedCount} buffered event(s)): ${res.data.status} ${await res.data.text()}`));
                    return;
                }
            }
        } finally{
    ...
    async _startRecording() {
        ...
        if (!this._rrwebModule) {
            const rrwebImport = await _hexclave_shared_dist_utils_results.Result.fromPromise(__turbopack_context__.A("[project]/node_modules/rrweb/es/rrweb/packages/rrweb/src/entries/all.js [app-client] (ecmascript, async loader)"));
...
exports.isAdBlockerNetworkError = isAdBlockerNetworkError;
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let __interfaces_client_app_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/client-app.js [app-client] (ecmascript)");
let __interfaces_server_app_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/server-app.js [app-client] (ecmascript)");
let __interfaces_admin_app_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/admin-app.js [app-client] (ecmascript)");
Object.defineProperty(exports, "HexclaveAdminApp", {
    enumerable: true,
    get: function() {
        return __interfaces_admin_app_js.HexclaveAdminApp;
    }
});
Object.defineProperty(exports, "HexclaveClientApp", {
    enumerable: true,
    get: function() {
        return __interfaces_client_app_js.HexclaveClientApp;
    }
});
Object.defineProperty(exports, "HexclaveServerApp", {
    enumerable: true,
    get: function() {
        return __interfaces_server_app_js.HexclaveServerApp;
    }
});
Object.defineProperty(exports, "StackAdminApp", {
    enumerable: true,
    get: function() {
        return __interfaces_admin_app_js.StackAdminApp;
    }
});
Object.defineProperty(exports, "StackClientApp", {
    enumerable: true,
    get: function() {
        return __interfaces_client_app_js.StackClientApp;
    }
});
Object.defineProperty(exports, "StackServerApp", {
    enumerable: true,
    get: function() {
        return __interfaces_server_app_js.StackServerApp;
    }
});
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/admin-app.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
//#region src/lib/hexclave-app/apps/interfaces/admin-app.ts
const HexclaveAdminApp = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/index.js [app-client] (ecmascript)")._HexclaveAdminAppImpl;
...
//#endregion
exports.HexclaveAdminApp = HexclaveAdminApp;
exports.StackAdminApp = StackAdminApp;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/client-app.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
//#region src/lib/hexclave-app/apps/interfaces/client-app.ts
const HexclaveClientApp = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/index.js [app-client] (ecmascript)")._HexclaveClientAppImpl;
...
//#endregion
exports.HexclaveClientApp = HexclaveClientApp;
exports.StackClientApp = StackClientApp;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/interfaces/server-app.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
//#region src/lib/hexclave-app/apps/interfaces/server-app.ts
const HexclaveServerApp = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/index.js [app-client] (ecmascript)")._HexclaveServerAppImpl;
...
//#endregion
exports.HexclaveServerApp = HexclaveServerApp;
exports.StackServerApp = StackServerApp;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/common.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//#endregion
exports.hexclaveAppInternalsSymbol = hexclaveAppInternalsSymbol;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/contact-channels/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let __apps_index_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/index.js [app-client] (ecmascript)");
let __common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/common.js [app-client] (ecmascript)");
let __url_targets_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/url-targets.js [app-client] (ecmascript)");
Object.defineProperty(exports, "HexclaveAdminApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.HexclaveAdminApp;
    }
});
Object.defineProperty(exports, "HexclaveClientApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.HexclaveClientApp;
    }
});
Object.defineProperty(exports, "HexclaveServerApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.HexclaveServerApp;
    }
});
Object.defineProperty(exports, "StackAdminApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.StackAdminApp;
    }
});
Object.defineProperty(exports, "StackClientApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.StackClientApp;
    }
});
Object.defineProperty(exports, "StackServerApp", {
    enumerable: true,
    get: function() {
        return __apps_index_js.StackServerApp;
    }
});
Object.defineProperty(exports, "getPagePrompt", {
    enumerable: true,
    get: function() {
        return __url_targets_js.getPagePrompt;
    }
});
Object.defineProperty(exports, "hexclaveAppInternalsSymbol", {
    enumerable: true,
    get: function() {
        return __common_js.hexclaveAppInternalsSymbol;
    }
});
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/internal-api-keys/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/passkey-rp-id.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function scopePasskeyRegistrationToHostname(options, hostname) {
    if (options.rp.id !== passkeyRpIdSentinel) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError(`Expected returned RP ID from server to equal sentinel, but found ${options.rp.id}`);
    options.rp.id = hostname;
}
function scopePasskeyAuthenticationToHostname(options, hostname) {
    if (options.rpId !== passkeyRpIdSentinel) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError(`Expected returned RP ID from server to equal sentinel, but found ${options.rpId}`);
    options.rpId = hostname;
}
//#endregion
exports.scopePasskeyAuthenticationToHostname = scopePasskeyAuthenticationToHostname;
exports.scopePasskeyRegistrationToHostname = scopePasskeyRegistrationToHostname;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/permissions/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//#endregion
exports.adminProjectPermissionDefinitionCreateOptionsToCrud = adminProjectPermissionDefinitionCreateOptionsToCrud;
exports.adminProjectPermissionDefinitionUpdateOptionsToCrud = adminProjectPermissionDefinitionUpdateOptionsToCrud;
exports.adminTeamPermissionDefinitionCreateOptionsToCrud = adminTeamPermissionDefinitionCreateOptionsToCrud;
exports.adminTeamPermissionDefinitionUpdateOptionsToCrud = adminTeamPermissionDefinitionUpdateOptionsToCrud;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/projects/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/teams/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/url-targets.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let _hexclave_shared_dist_utils_errors = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/errors.js [app-client] (ecmascript)");
let _hexclave_shared_dist_interface_handler_urls = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/interface/handler-urls.js [app-client] (ecmascript)");
let _hexclave_shared_dist_utils_redirect_urls = __turbopack_context__.r("[project]/node_modules/@hexclave/next/node_modules/@hexclave/shared/dist/utils/redirect-urls.js [app-client] (ecmascript)");
let ______generated_env_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/generated/env.js [app-client] (ecmascript)");
...
const customPagePrompts = (0, _hexclave_shared_dist_interface_handler_urls.getCustomPagePrompts)();
...
const assertOAuthCallbackTargetIsRelative = (target)=>{
    ...
    if (url != null && !isRelativeUrlString(url)) throw new _hexclave_shared_dist_utils_errors.HexclaveAssertionError("OAuth callback URLs must be relative.", {
...
//#endregion
exports.buildCliAuthConfirmUrl = buildCliAuthConfirmUrl;
exports.getHostedHandlerUrl = getHostedHandlerUrl;
exports.getPagePrompt = getPagePrompt;
exports.isHostedHandlerUrlForProject = isHostedHandlerUrlForProject;
exports.isLocalHandlerUrlTarget = isLocalHandlerUrlTarget;
exports.resolveHandlerUrls = resolveHandlerUrls;
exports.resolveUnknownHandlerPathFallbackUrl = resolveUnknownHandlerPathFallbackUrl;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/users/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function userUpdateOptionsToCrud(options) {
    return {
        ...
        totp_secret_base64: options.totpMultiFactorSecret != null ? (0, _hexclave_shared_dist_utils_bytes.encodeBase64)(options.totpMultiFactorSecret) : options.totpMultiFactorSecret,
        profile_image_url: options.profileImageUrl,
...
"[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/workflows.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//#endregion
exports.adminWorkflowFromCrud = adminWorkflowFromCrud;
exports.adminWorkflowRunDetailsFromCrud = adminWorkflowRunDetailsFromCrud;
exports.adminWorkflowRunFromCrud = adminWorkflowRunFromCrud;
exports.adminWorkflowSyncResultFromCrud = adminWorkflowSyncResultFromCrud;
exports.adminWorkflowVersionFromCrud = adminWorkflowVersionFromCrud;
exports.isWorkflowRunDetailsJson = isWorkflowRunDetailsJson;
}),
"[project]/node_modules/@hexclave/next/dist/lib/hooks.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
let react = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
let ___providers_hexclave_context_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/providers/hexclave-context.js [app-client] (ecmascript)");
...
*/ function useHexclaveApp(options = {}) {
    ...
    const context = (0, react.useContext)(___providers_hexclave_context_js.HexclaveContext);
...
"[project]/node_modules/@hexclave/next/dist/lib/translations.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
let react = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
react = require_rolldown_runtime.__toESM(react);
let ___providers_translation_provider_client_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/providers/translation-provider-client.js [app-client] (ecmascript)");
//#region src/lib/translations.tsx
function useTranslation() {
    const translationContext = react.default.useContext(___providers_translation_provider_client_js.TranslationContext);
...
//# sourceMappingURL=node_modules_%40hexclave_next_dist_lib_0x7gcr0._.js.map