...
"[project]/node_modules/@hexclave/next/dist/dev-tool/dev-tool-core.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
let ___lib_hexclave_app_url_targets_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/url-targets.js [app-client] (ecmascript)");
let ___in_page_ui_logo_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/in-page-ui/logo.js [app-client] (ecmascript)");
let ___lib_hexclave_app_apps_implementations_common_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/lib/hexclave-app/apps/implementations/common.js [app-client] (ecmascript)");
let __dev_tool_styles_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/dev-tool/dev-tool-styles.js [app-client] (ecmascript)");
let __dev_tool_trigger_position_js = __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/dev-tool/dev-tool-trigger-position.js [app-client] (ecmascript)");
...
function appendInlineMarkdown(container, text) {
    ...
    while((match = tokenPattern.exec(text)) !== null){
        ...
        const token = match[0];
        if (token.startsWith("`")) container.appendChild((0, ___in_page_ui_dom_js.h)("code", {
            className: "sdt-ai-inline-code"
        }, token.slice(1, -1)));
        else if (token.startsWith("**") || token.startsWith("__")) {
            const bold = (0, ___in_page_ui_dom_js.h)("strong", {
...
function createTrigger(onClick) {
    ...
    function loadPlacement() {
        try {
            ...
            if (isPosition(parsed)) return (0, __dev_tool_trigger_position_js.getSnappedTriggerPlacement)(parsed, triggerSize, {
    ...
    const logoSpan = (0, ___in_page_ui_dom_js.h)("span", {
        className: "sdt-trigger-logo"
    });
    (0, ___in_page_ui_dom_js.setHtml)(logoSpan, ___in_page_ui_logo_js.HEXCLAVE_LOGO_SVG);
    ...
    requestAnimationFrame(()=>{
        ...
        if (rect.width > 0 && rect.height > 0) {
            ...
            const measured = (0, __dev_tool_trigger_position_js.resolveTriggerPosition)(placement, triggerSize, {
                width: window.innerWidth,
                height: window.innerHeight
            });
    ...
    btn.addEventListener("pointermove", (e)=>{
        ...
        applyPos((0, __dev_tool_trigger_position_js.clampTriggerPosition)({
    ...
    btn.addEventListener("pointerup", (e)=>{
        ...
        if (ds.didDrag) {
            placement = (0, __dev_tool_trigger_position_js.getSnappedTriggerPlacement)(pos, triggerSize, {
                width: window.innerWidth,
                height: window.innerHeight
            });
            applyPos((0, __dev_tool_trigger_position_js.resolveTriggerPosition)(placement, triggerSize, {
                width: window.innerWidth,
                height: window.innerHeight
            }), {
                animate: true
    ...
    function onResize() {
        const resizedPos = (0, __dev_tool_trigger_position_js.resolveTriggerPosition)(placement, triggerSize, {
            width: window.innerWidth,
            height: window.innerHeight
        });
...
function createTabBar(tabs, activeTab, onTabChange, opts) {
    ...
    const bar = (0, ___in_page_ui_dom_js.h)("div", {
        className: barClass
    });
    const indicator = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    const buttons = tabs.map((tab)=>{
        ...
        if (tab.icon) {
            const iconSpan = (0, ___in_page_ui_dom_js.h)("span", {
    ...
    if (variant === "bar") bar.appendChild((0, ___in_page_ui_dom_js.h)("div", {
...
function populateIframeTab(container, src, title, loadingMsg = "Loading…", errorMsg = "Unable to load content", errorDetail, openExternallyLabel) {
    container.innerHTML = "";
    if (openExternallyLabel != null) container.appendChild((0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-iframe-toolbar"
    }, (0, ___in_page_ui_dom_js.h)("a", {
        href: src,
        target: "_blank",
        rel: "noopener noreferrer",
        className: "sdt-iframe-open-link"
    }, openExternallyLabel)));
    const loadingEl = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    iframe.addEventListener("error", ()=>{
        loadingEl.style.display = "none";
        container.innerHTML = "";
        const errDiv = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-iframe-error"
        });
        errDiv.appendChild((0, ___in_page_ui_dom_js.h)("div", null, errorMsg));
        if (errorDetail) errDiv.appendChild((0, ___in_page_ui_dom_js.h)("div", {
            style: {
                fontSize: "12px",
...
function createOverviewTab(app) {
    ...
    const heroCard = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-card sdt-ov-card-hero"
    });
    heroCard.appendChild((0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-label"
    }, "Identity"));
    const userRow = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-user-row"
    });
    const avatar = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-avatar"
    }, "?");
    const userMeta = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-user-meta"
    });
    const userName = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-user-name"
    }, "Loading…");
    const userEmail = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    const actions = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function rebuildActions() {
        ...
        if (currentUser) {
            const signOutBtn = (0, ___in_page_ui_dom_js.h)("button", {
            ...
            const randomBtn = (0, ___in_page_ui_dom_js.h)("button", {
            ...
            const quickBtn = (0, ___in_page_ui_dom_js.h)("button", {
    ...
    const methodsCard = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-card sdt-ov-card-auth"
    });
    methodsCard.appendChild((0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-label"
    }, "Auth Methods"));
    const authGrid = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ov-auth-grid"
    });
    for(let i = 0; i < 3; i++)authGrid.appendChild((0, ___in_page_ui_dom_js.h)("div", {
    ...
    async function loadAuthMethods() {
        try {
            ...
            for (const m of methods){
                const pill = (0, ___in_page_ui_dom_js.h)("div", {
                    className: `sdt-ov-method ${m.enabled ? "sdt-ov-method-on" : "sdt-ov-method-off"}`
                });
                pill.appendChild((0, ___in_page_ui_dom_js.h)("span", {
    ...
    const checksCard = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function buildChecklist() {
        ...
        const titleRow = (0, ___in_page_ui_dom_js.h)("div", {
        ...
        const badge = (0, ___in_page_ui_dom_js.h)("span", {
        ...
        const fill = (0, ___in_page_ui_dom_js.h)("div", {
        ...
        for (const c of checks){
            ...
            row.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: `sdt-ov-setup-dot ${c.ok ? "sdt-ov-setup-dot-ok" : "sdt-ov-setup-dot-warn"}`
            }));
            row.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: "sdt-ov-setup-label"
            }, c.label));
            if (!c.ok && c.hint) row.appendChild((0, ___in_page_ui_dom_js.h)("span", {
    ...
    buildChecklist();
    (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(refreshUser());
...
function createConsoleTab(logStore) {
    ...
    const title = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    container.appendChild((0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-console-header"
    }, title, actions));
    const contentArea = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function renderLogItem(item) {
        if (item.kind === "api") {
            ...
            if (log.status !== void 0) row.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: `sdt-log-status ${log.status < 400 ? "sdt-log-status-ok" : "sdt-log-status-err"}`
            }, String(log.status)));
            if (log.duration !== void 0) row.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: "sdt-log-time"
            }, log.duration + "ms"));
            return row;
        }
    ...
    function renderLogs() {
        ...
        if (visibleLogCount < merged.length) list.appendChild((0, ___in_page_ui_dom_js.h)("div", {
...
function createAITab(app) {
    ...
    const messagesArea = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-ai-messages"
    });
    const inputArea = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function getHeaders() {
        const opts = app[___lib_hexclave_app_common_js.hexclaveAppInternalsSymbol].getConstructorOptions();
        const headers = {
    ...
    function renderToolCard(toolCall) {
        const toolCard = (0, ___in_page_ui_dom_js.h)("div", {
        ...
        header.appendChild((0, ___in_page_ui_dom_js.h)("span", {
        ...
        if (toolCall.isExpanded) {
            ...
            if (toolCall.argsText !== null) {
                body.appendChild((0, ___in_page_ui_dom_js.h)("div", {
                    className: "sdt-ai-tool-label"
                }, "Args"));
                const argsPre = (0, ___in_page_ui_dom_js.h)("pre", {
            ...
            if (toolCall.resultText !== null) {
                ...
                const resultPre = (0, ___in_page_ui_dom_js.h)("pre", {
                    className: "sdt-ai-tool-pre"
                });
                resultPre.appendChild((0, ___in_page_ui_dom_js.h)("code", null, toolCall.resultText));
                body.appendChild(resultPre);
            }
            if (toolCall.state === "running") body.appendChild((0, ___in_page_ui_dom_js.h)("div", {
    ...
    function renderMessages() {
        ...
        if (messages.length === 0) {
            ...
            const icon = (0, ___in_page_ui_dom_js.h)("div", {
            ...
            empty.appendChild((0, ___in_page_ui_dom_js.h)("div", {
            ...
            const suggestions = (0, ___in_page_ui_dom_js.h)("div", {
            ...
            for (const q of SUGGESTED_QUESTIONS){
                ...
                btn.appendChild((0, ___in_page_ui_dom_js.h)("span", {
        ...
        for (const msg of messages)if (msg.role === "user") {
            ...
            if (msg.parts.length === 0) bubble.innerHTML = "<div class=\"sdt-ai-thinking\"><span class=\"sdt-ai-thinking-dot\"></span><span class=\"sdt-ai-thinking-dot\"></span><span class=\"sdt-ai-thinking-dot\"></span></div>";
                ...
                if (part.type === "text") {
                    const textContainer = (0, ___in_page_ui_dom_js.h)("div", {
                ...
                if (toolCall == null) {
                    const missingTool = (0, ___in_page_ui_dom_js.h)("div", {
                        className: "sdt-ai-tool-card"
                    });
                    const missingBody = (0, ___in_page_ui_dom_js.h)("div", {
                        className: "sdt-ai-tool-body"
                    });
                    missingBody.appendChild((0, ___in_page_ui_dom_js.h)("div", {
                        className: "sdt-ai-tool-label"
                    }, "Error"));
                    const missingPre = (0, ___in_page_ui_dom_js.h)("pre", {
                        className: "sdt-ai-tool-pre"
                    });
                ...
                const toolsContainer = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function renderMarkdownInto(el, content) {
        function appendBlockWithInlineMarkdown(tag, className, text) {
            const block = (0, ___in_page_ui_dom_js.h)(tag, {
                className
            });
        ...
        while(i < lines.length){
            ...
            if (line.startsWith("```")) {
                ...
                i++;
                const block = (0, ___in_page_ui_dom_js.h)("div", {
                    className: "sdt-ai-code-block"
                });
                const header = (0, ___in_page_ui_dom_js.h)("div", {
                ...
                const pre = (0, ___in_page_ui_dom_js.h)("pre", {
            ...
            if (/^[-*] /.test(line)) {
                const ul = (0, ___in_page_ui_dom_js.h)("ul", {
            ...
            if (/^\d+\. /.test(line)) {
                const ol = (0, ___in_page_ui_dom_js.h)("ol", {
    ...
    const inputWrapper = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    input.addEventListener("keydown", (e)=>{
        if (e.key === "Enter" && !e.shiftKey) {
            ...
            if (aiLoading) activeAiAbortController?.abort();
                ...
                (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(sendMessage(input.value));
                input.value = "";
            }
            renderInput();
        }
...
function createDashboardTab(app) {
    ...
    function showUnavailable() {
        container.innerHTML = "";
        const message = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-dashboard-unavailable"
        });
        const text = (0, ___in_page_ui_dom_js.h)("div", {
...
function createSupportTab(app) {
    ...
    function createFeedbackForm() {
        const pane = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-support-feedback-pane"
        });
        const form = (0, ___in_page_ui_dom_js.h)("form", {
        ...
        function render() {
            form.innerHTML = "";
            if (status === "success") {
                const successDiv = (0, ___in_page_ui_dom_js.h)("div", {
                ...
                successDiv.append(icon, (0, ___in_page_ui_dom_js.h)("div", {
                    className: "sdt-support-status-title"
                }, "Feedback sent"), (0, ___in_page_ui_dom_js.h)("div", {
            ...
            if (status === "error") {
                ...
                errDiv.append(icon, (0, ___in_page_ui_dom_js.h)("div", {
                    className: "sdt-support-status-title"
                }, "Failed to send"), (0, ___in_page_ui_dom_js.h)("div", {
                    className: "sdt-support-status-msg"
            ...
            const nameField = (0, ___in_page_ui_dom_js.h)("div", {
                className: "sdt-support-field"
            });
            const nameLabel = (0, ___in_page_ui_dom_js.h)("label", {
                className: "sdt-support-label"
            }, "Name ");
            nameLabel.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: "sdt-support-optional"
            }, "optional"));
            nameField.append(nameLabel, nameInput);
            form.appendChild(nameField);
            const emailField = (0, ___in_page_ui_dom_js.h)("div", {
                className: "sdt-support-field"
            });
            emailField.append((0, ___in_page_ui_dom_js.h)("label", {
                className: "sdt-support-label"
            }, "Email"), emailInput);
            form.appendChild(emailField);
            const msgField = (0, ___in_page_ui_dom_js.h)("div", {
                className: "sdt-support-field"
            });
            msgField.append((0, ___in_page_ui_dom_js.h)("label", {
                className: "sdt-support-label"
            ...
            const typeCards = (0, ___in_page_ui_dom_js.h)("div", {
            ...
            const channels = (0, ___in_page_ui_dom_js.h)("div", {
...
function createComponentsTab(app) {
    ...
    const apiBaseUrl = resolveApiBaseUrl(app);
    const urls = app[___lib_hexclave_app_common_js.hexclaveAppInternalsSymbol].getUrls();
    ...
    (0, _hexclave_shared_dist_utils_promises.runAsynchronously)(fetch(`${apiBaseUrl}/api/latest/internal/component-versions`).then((r)=>r.json()).then((data)=>{
    ...
    const sidebar = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-pg-sidebar"
    });
    const mainArea = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function renderSidebar() {
        ...
        head.appendChild((0, ___in_page_ui_dom_js.h)("span", {
            className: "sdt-pg-sidebar-title"
        }, "Pages"));
        head.appendChild((0, ___in_page_ui_dom_js.h)("span", {
            className: "sdt-pg-sidebar-count"
        }, String(pages.length)));
        if (outdatedCount > 0) head.appendChild((0, ___in_page_ui_dom_js.h)("span", {
        ...
        for (const page of pages){
            ...
            item.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: `sdt-pg-item-dot ${dotClass}`
            }));
            item.appendChild((0, ___in_page_ui_dom_js.h)("span", {
                className: "sdt-pg-item-label"
            }, page.label));
            if (isOutdated) item.appendChild((0, ___in_page_ui_dom_js.h)("span", {
    ...
    function renderDetail(page) {
        mainArea.innerHTML = "";
        const detail = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-pg-detail"
        });
        const header = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-pg-header"
        });
        const headerTop = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-pg-header-top"
        });
        headerTop.appendChild((0, ___in_page_ui_dom_js.h)("h3", {
            className: "sdt-pg-title"
        }, `${page.label} Page`));
        if (page.versionStatus === "outdated") headerTop.appendChild((0, ___in_page_ui_dom_js.h)("span", {
            className: "sdt-pg-badge sdt-pg-badge-outdated"
        }, "Outdated"));
        header.appendChild(headerTop);
        const redirectMethod = `hexclaveApp.redirectTo${page.key.charAt(0).toUpperCase()}${page.key.slice(1)}()`;
        const codeRow = (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-pg-code-inline"
        });
        codeRow.appendChild((0, ___in_page_ui_dom_js.h)("code", {
            className: "sdt-pg-code"
        }, redirectMethod));
        const openBtn = (0, ___in_page_ui_dom_js.h)("button", {
        ...
        const prompt = (0, ___lib_hexclave_app_url_targets_js.getPagePrompt)(page.key, page.version ?? void 0);
        if (prompt) {
            const isOutdated = page.versionStatus === "outdated";
            if (page.classification === "handler-component" || page.classification === "hosted" || isOutdated) {
                ...
                if (promptText) {
                    const section = (0, ___in_page_ui_dom_js.h)("div", {
                        className: "sdt-pg-section"
                    });
                    section.appendChild((0, ___in_page_ui_dom_js.h)("div", {
                    ...
                    section.appendChild((0, ___in_page_ui_dom_js.h)("pre", {
                        className: "sdt-pg-pre"
                    }, promptText));
                    const footer = (0, ___in_page_ui_dom_js.h)("div", {
...
function createPanel(app, state, logStore, onClose) {
    const panel = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-panel"
    });
    ...
    const inner = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    const tabBar = createTabBar(tabs, activeTab, (id)=>{
        ...
        trailing: (0, ___in_page_ui_dom_js.h)("div", {
            className: "sdt-tabbar-actions"
        }, docsLink, closeBtn)
    });
    inner.appendChild(tabBar.el);
    const content = (0, ___in_page_ui_dom_js.h)("div", {
        className: "sdt-content"
    });
    const layers = (0, ___in_page_ui_dom_js.h)("div", {
    ...
    function addResizeHandle(edge) {
        const handle = (0, ___in_page_ui_dom_js.h)("div", {
...
function createDevTool(app) {
    ...
    const removeRequestListener = app[___lib_hexclave_app_common_js.hexclaveAppInternalsSymbol].addRequestListener((entry)=>{
...
"[project]/node_modules/@hexclave/next/dist/dev-tool/dev-tool-styles.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, Symbol.toStringTag, {
    value: "Module"
});
//#region src/dev-tool/dev-tool-styles.ts
const devToolCSS = (0, __turbopack_context__.r("[project]/node_modules/@hexclave/next/dist/in-page-ui/base-styles.js [app-client] (ecmascript)").getInPageUiBaseCSS)(".hexclave-devtool") + `
  /* Trigger pill */
...
`;
//#endregion
exports.devToolCSS = devToolCSS;
}),
"[project]/node_modules/@hexclave/next/dist/dev-tool/dev-tool-trigger-position.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//#endregion
exports.TRIGGER_EDGE_MARGIN = TRIGGER_EDGE_MARGIN;
exports.clampTriggerPosition = clampTriggerPosition;
exports.getSnappedTriggerPlacement = getSnappedTriggerPlacement;
exports.resolveTriggerPosition = resolveTriggerPosition;
}),
]);

//# sourceMappingURL=node_modules_%40hexclave_next_dist_dev-tool_212ks-m._.js.map